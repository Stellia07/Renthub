...
<section class="feature-section sec-pad bg-color-1">
    <div class="auto-container">
        <div class="sec-title centred">
            ...
            <p>Explore our Featured Properties section to discover a curated selection of the finest real estate listings,  <br />each chosen for its exceptional quality, unique charm, and prime location.</p>
        </div>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <div class="author-info clearfix">
                                ...
                                <div class="buy-btn pull-right"><a href="{{ route('rent.property') }}">For Rent</a></div>
                            </div>
