...
Route::post('/upload/contract', [ContractController::class, 'upload'])->name('upload.contract');
Route::get('/contracts/view/{id}', [ContractController::class, 'view'])->name('contracts.view');
Route::get('contracts/download/{id}', [ContractController::class, 'download'])->name('contracts.download');
Route::get('/owner/tenant/manager', [ContractController::class, 'showTenants'])->name('owner.tenant.manager');
...
//Route::get('/contracts/view/{id}', [ContractController::class, 'view'])->name('contracts.view');
// web.php
Route::put('/contracts/update', [ContractController::class, 'update'])->name('contracts.update');

Route::get('/receipt/view/{tenantId}', [RentReceiptController::class, 'viewReceipt'])->name('receipt.view');
Route::get('receipt/view-by-log/{logId}', [RentReceiptController::class, 'viewReceiptByLogId'])->name('receipt.view-by-log');
...
// web.php
Route::get('/contract-tenant', [ContractController::class, 'leaseAgreement'])->name('tenant.contract');

Route::get('/lease-agreement', [LeaseController::class, 'leaseAgreementForm'])->name('lease.agreement.form');

//new agreement
Route::get('/lease-agreement/by-address/{renterAddress}', [LeaseController::class, 'showByRenterAddress'])->name('leaseAgreement.showByAddress');
Route::get('/lease/create', [LeaseController::class, 'create'])->name('lease.create');
Route::post('/lease/store', [LeaseController::class, 'store'])->name('lease.store');

//receipt

// Route for displaying the form
Route::get('/rent-receipt', [RentReceiptController::class, 'create'])->name('rent-receipts.create');

// Route for handling the form submission
Route::post('/rent-receipt', [RentReceiptController::class, 'store'])->name('rent-receipts.store');


//Route::get('/generate-receipt/{logId}', [RentReceiptController::class, 'generate'])->name('generate-receipt');
Route::get('/rent-receipt/{logId}', [RentReceiptController::class, 'createWithLogId'])->name('rent-receipt-with-log');
Route::get('/owner/payment-logs', [RentReceiptController::class, 'paymentLogs'])->name('owner.payment.logs');
Route::get('/owner/payment-logs', [RentReceiptController::class, 'create_rent_receipt'])->name('owner.payment.logs');
Route::get('/rent-receipt/view/{logId}', [RentReceiptController::class, 'viewWithLogId'])->name('rent-receipt-view');
...
Route::get('/path/to/filter/route', [PaymentLogController::class, 'PaymentLogs'])->name('paymentLogs.show');
//billings
...
Route::get('/utilities', [OwnerPropertyController::class, 'utilities'])->name('utilities.billing');
...
Route::get('/unread-message-count', [ChatController::class, 'getUnreadMessageCount'])->name('unread.message.count');
